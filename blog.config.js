...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个热衷于安稳又幸福还对铁道有亿点痴迷的博主🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://happinessrailway.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,铁道,生活,记录,幸福,痴迷,BVE,Traincrew,Railroute,铁路调度模拟器', // 网站关键词 英文逗号隔开
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/661717722', // B站主页
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || p3htd150vw , // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-2836618066350136', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
