...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客,铁道,生活,记录,幸福,痴迷,BVE,Traincrew,Railroute,铁路调度模拟器,Bve Trainsim,BveTs,火车模拟器,济北铁道,BVE线路开发,BVE线路制作,BVE5', // 网站关键词 英文逗号隔开
