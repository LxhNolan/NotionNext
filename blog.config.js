...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '铁道,生活,记录,幸福,BVE,Traincrew,Railroute,铁路调度模拟器,Bve Trainsim,济北铁道,Jibei Railway,済北鉄道,爱好,作品,BVE Add-on', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20251649号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20251649', // 备案查询链接，如果用了萌备等备案请在这里填写-https://beian.miit.gov.cn/
